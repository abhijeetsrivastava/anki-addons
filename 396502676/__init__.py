...
def param_wraps(cmd):
    def result(editor):
        ...
        editor.web.eval(fr"wrapper_main.callCmd(wrapper_commands.{c['action']}, '{begin}', '{end}');")
...
def on_webview_will_set_content(web_content: WebContent, editor):
    if isinstance(editor, Editor):
        # web_content.js.append(f"js/vendor/jquery.min.js")
        ...
        web_content.js.append(f"/_addons/{addon_package}/main.js")
